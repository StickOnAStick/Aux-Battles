            ...
            <div className="drawer drawer-end">
                ...
                <div className="drawer-content">
                    ...
                    <div className="w-full h-full flex flex-col items-center">
                        ...
                        {/* Side Nav Toggle*/}
                        <label htmlFor="RHSDrawer" className="lg:hidden drawer-button btn btn-square btn-accent text-primary border-primary border-opacity-20 swap swap-rotate absolute top-2 right-2 ">
                            <input type="checkbox" />
